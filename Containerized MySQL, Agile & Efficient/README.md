...
- ✅ Create an SQL initialization script (e.g., `Deva_demo.sql`) with database and table definitions.
...
COPY Deva_demo.sql /docker-entrypoint-initdb.d/
...
Create a file named `Deva_demo.sql` in the same directory:
